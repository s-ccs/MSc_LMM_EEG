...
# ╔═╡ 6525f9d2-f821-4a9a-9976-112f8a2936cf
using MixedModelsSim, DataFrames

# ╔═╡ 1508b447-d8e3-4ae5-b0d9-cc0413b1e248
begin
	...
	ExperimentDesign(n_subj, n_item, subj_btwn, item_btwn, both_win, evt_seq) = ExperimentDesign(n_subj, n_item, subj_btwn, item_btwn, both_win, evt_seq, nothing)
end

# ╔═╡ e55e0c6c-0567-4b8d-953e-4f16bf161bb6
struct Test 
	exd::ExperimentDesign
end

# ╔═╡ ba53565a-7425-4c31-8cb7-307041d7648d

function generate!(expdesign::ExperimentDesign)
	expdesign.data = DataFrame(
...
# ╔═╡ a9721639-e17f-47b5-9a18-921090569170


# ╔═╡ 7b5e516c-0d92-11ed-3345-29e8d4cc16eb


# ╔═╡ ad8b8d2c-fbf9-4314-8197-307b8fdb7b23


# ╔═╡ 446d627d-b072-4172-9f55-061e57dc04cd
md"""
# Playground
"""

# ╔═╡ 4a80c6fc-d219-41d2-84d6-6d22a2adfdba
ex = ExperimentDesign(2,1,1,1,1,1)

# ╔═╡ 689b1d22-dcd6-4bf0-9418-a14d8a7a4897
t = Test(ex)

# ╔═╡ ab22866c-2ca2-44e5-82c6-628920c54ba1
generate!(t.exd)

# ╔═╡ 680076f4-3776-4c75-8550-4a737938f980
t

# ╔═╡ d97e0dba-7c03-47a8-8b38-b02bdb56bcc8
